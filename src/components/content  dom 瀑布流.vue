...
//										var box = `'<div class="box"><div class="boxcon"><div class="pic" @click="modalS()"><img src="/instatic/img/1.d80e543.png"/><div class="modal"></div></div><div class="footer"><div class="borderbox"><span class="thumb"><img src="../assets/logo.png"/></span><div style="width: 15px;"></div><div class="box-txt"><p>用户名</p><div style="height: 5px;"></div><p>介绍</p></div><ul><li><Icon type="heart"></Icon></li></ul></div></div></div></div>'`
						 				$("#main").append(box);
                }
