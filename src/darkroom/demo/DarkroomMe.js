...
function () {
    ...
    var Crop = Darkroom.Transformation.extend({
        ...
        CropZone = fabric.util.createClass(fabric.Rect, {
            _render: function (ctx) {
                ...
                ctx.beginPath(), ctx.moveTo(x0 - 1, y0 - 1), ctx.lineTo(x3 + 1, y0 - 1), ctx.lineTo(x3 + 1, y3 + 1), ctx.lineTo(x0 - 1, y3 - 1), ctx.lineTo(x0 - 1, y0 - 1), ctx.closePath(), ctx.moveTo(x1, y1), ctx.lineTo(x1, y2), ctx.lineTo(x2, y2), ctx.lineTo(x2, y1), ctx.lineTo(x1, y1), ctx.closePath(), ctx.fill()
    ...
    Darkroom.plugins.crop = Darkroom.Plugin.extend({
        ...
        initialize: function () {
    		...
    		this.darkroom.addEventListener("core:transformation",
            ...
            if (this.hasFocus()) {
                ...
                if (currentObject === this.cropZone) {
                    ...
                    x < 0 && currentObject.set("left", 0), y < 0 && currentObject.set("top", 0), x > maxX && currentObject.set("left", maxX), y > maxY && currentObject.set("top", maxY), this.darkroom.dispatchEvent("crop:update")
                }
            }
            ...
            if (this.hasFocus()) {
                ...
                if (currentObject === this.cropZone) {
                    ...
                    if (null !== this.options.ratio && (minX < 0 || maxX > canvas.getWidth() || minY < 0 || maxY > canvas.getHeight()) && (preventScaling = !0), minX < 0 || maxX > canvas.getWidth() || preventScaling) {
                        var lastScaleX = this.lastScaleX || 1;
                        currentObject.setScaleX(lastScaleX)
                    }
                    if (minX < 0 && currentObject.setLeft(0), minY < 0 || maxY > canvas.getHeight() || preventScaling) {
                        var lastScaleY = this.lastScaleY || 1;
                        currentObject.setScaleY(lastScaleY)
                    }
                    minY < 0 && currentObject.setTop(0), currentObject.getWidth() < this.options.minWidth && currentObject.scaleToWidth(this.options.minWidth), currentObject.getHeight() < this.options.minHeight && currentObject.scaleToHeight(this.options.minHeight), this.lastScaleX = currentObject.getScaleX(), this.lastScaleY = currentObject.getScaleY(), this.darkroom.dispatchEvent("crop:update")
                }
            }
        ...
        cropCurrentZone: function () {
            ...
            if (this.hasFocus() && !(this.cropZone.width < 1 && this.cropZone.height < 1)) {
                ...
                top < 0 && (height += top, top = 0), left < 0 && (width += left, left = 0),
            ...
            if (this.options.ratio && +this.options.ratio !== currentRatio) {
                ...
                if (leftX < 0 && (leftX = 0), topY < 0 && (topY = 0), leftX + width > canvas.getWidth()) {
